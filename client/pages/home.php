...
<head>
    ...
    <title>Gold Coast Ledger - Putting fun in funds since 1969</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent pb-5">
        <div class="container">
            <a class="navbar-brand nav-logo" href="#">
                <img src="../assets/img/e.png" alt="Logo" width="200">
            </a>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-12 col-md-8 text-center">
                    <p class="text-center section-subtitle">
                        ...
                        and join the financial fiesta at Gold Coast Ledger! Where your hard-earned moolah gets more action
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <p class="bease-subtitle mb-5">Unleash Your Inner Financial Ninja with Gold Coast Ledger's Killer Tools
                    </p>
                    <div class="row">
    ...
    <footer id="contact">
        <div class="container pt-5 pb-3">
            <div class="row">
                <div class="col-lg-3">
                    <h5>About</h5>
                    <p>Gold Coast Ledger was founded by the one and only, Sangam Adhikari, a financial wizard with a passion
                        for puns.</p>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a href="#"><i class="fab fa-facebook fa-lg"
                                    id="icon-awesome"></i></a></li>
