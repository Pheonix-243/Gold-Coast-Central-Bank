    ...
    <section class="content" id="top">
       <div class="container-fluid">
            <div class="block-header">
                <p style="margin-left: -15px; font-size: 17px; font-weight: bold;"><?php echo $_GET["id"]." Accounts List"?></p>
            </div>
                    ...
                    <table class="table" id="myTable">
                      ...
                      <tbody id="body">
                        ...
                        <tr style="height: 50px;">
                           ...
                           <td style="text-align: center;padding-top: 25px;"><?php echo $row['fnm'];?></td>
                        ...
                        $sql="SELECT accountsholder.account as acc,accountsholder.cnic as cn,accountsholder.image as img,accountsholder.name as nm,accountsholder.fname as fnm,accounts_info.account_title AS tit,accounts_info.account_type AS typ, accounts_info.registerdate AS det FROM accountsholder,accounts_info where accountsholder.account=accounts_info.account and accounts_info.account_type='$type1' ORDER BY accountsholder.account DESC";
                        $result = mysqli_query($con,$sql);
                        $num = (mysqli_query($con,$sql));
                         if(mysqli_num_rows($num)>0){
                         while($row=mysqli_fetch_array ($result)){
