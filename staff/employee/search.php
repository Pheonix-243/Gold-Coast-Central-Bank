    ...
    <section class="content" id="top">
       <div class="container-fluid">
            ...
            <br>
                <div class="row">
                <div class="col-sm-4">
                    <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()" placeholder="Search with name, cnic, title, account" title="Type in a name">
                </div>
                <div  class="col-sm-2">
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr style="text-align: center;" class="tb">
                          ...
                          <th style="text-align: center; width: 11%;">Account Type</th>
                      ...
                      <tbody id="body">
                        ...
                        $sql="SELECT accountsholder.account as acc,accountsholder.cnic as cn,accountsholder.image as img,accountsholder.name as nm,accounts_info.account_title AS tit,accounts_info.account_type AS typ, accounts_info.registerdate AS det FROM accountsholder,accounts_info where accountsholder.account=accounts_info.account and accounts_info.registerdate between '$startdt' and '$enddt' ORDER BY accountsholder.account DESC";
                        ...
                        <tr style="height: 50px;">
                           <td style="text-align: center; padding: 2px 2px 2px 2px;"><?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['img']) .'" style="width:60px; height:60px;"/>'  ?></td>
                           <td style="text-align: center;padding-top: 25px;"><?php echo $row['nm'];?></td>
                           <td style="text-align: center;padding-top: 25px;"><?php echo $row['cn'];?></td>
                           ...
                           <td style="text-align: center;padding-top: 25px;"><?php echo $row['typ'];?></td>
                           <td style="text-align: center;padding-top: 15px;"><div class="action_btn">
                            <a href="view_profile.php?id=<?php echo $row['acc'];?>" class="click_ripple_shine success" title="View"><i class="icon fa fa-eye"></i> </a>
                           <a href="update.php?id=<?php echo $row['acc'];?>" class="click_ripple_shine warning" title="Edit"><i class="icon fa fa-pencil-square-o"></i></a>
                           <a href="delete.php?id=<?php echo $row['acc'];?>" class="danger" title="Delete"><i class="icon fa fa-close"></i></a>
                           </div>
                       </td>
                        <?php
                         }
                        ...
                        $sql="SELECT accountsholder.account as acc,accountsholder.cnic as cn,accountsholder.image as img,accountsholder.name as nm,accounts_info.account_title AS tit,accounts_info.account_type AS typ, accounts_info.registerdate AS det FROM accountsholder,accounts_info where accountsholder.account=accounts_info.account ORDER BY accountsholder.account DESC";
                        $result = mysqli_query($con,$sql);
                        $num = (mysqli_query($con,$sql));
                         if(mysqli_num_rows($num)>0){
                         while($row=mysqli_fetch_array ($result)){
                        ...
                        <tr style="height: 50px;">
                           ...
                           <td style="text-align: center;padding-top: 25px;"><?php echo $row['acc'];?></td>
                           <td style="text-align: center;padding-top: 25px;"><?php echo $row['typ'];?></td>
                           <td style="text-align: center;padding-top: 15px;"><div class="action_btn"><a href="view_profile.php?id=<?php echo $row['acc'];?>" class="click_ripple_shine success" title="View"><i class="icon fa fa-eye"></i> </a>
                           <a href="update.php?id=<?php echo $row['acc'];?>" class="click_ripple_shine warning" title="Edit"><i class="icon fa fa-pencil-square-o"></i></a>
                           <a href="delete.php?id=<?php echo $row['acc'];?>" class="danger"title="Delete"><i class="icon fa fa-close"></i></a>
                           </div>
                       </td>
