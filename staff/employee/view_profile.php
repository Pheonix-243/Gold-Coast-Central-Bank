                   ...
                   <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control"  name="acc_type" value="<?php echo $row['account_type'];?> " readonly>
                            </div>
                             <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Register Date</p>
                                <input type="text" class="form-control"  name="reg" value="<?php echo $row['registerdate'];?>" readonly>
                            </div>
                        </div>
                        <hr style="height:1px;border-width:0; width: 100%; margin-bottom:-5px; color:red;background-color:gray;">
                        <br>
                        <p style="text-align: left; font-weight: bold;">Account Balance Information</p>
                        <div class="row">
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="text" class="form-control" value="<?php  echo $dp1;?>" readonly>
                            </div>
                            <div class="col-lg-2">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Withdraw Balance</p>
                            ...
                            <div class="col-lg-2">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Recieved Balance</p>
                                <input type="text" class="form-control" value="<?php  echo $gt1;?>" readonly>
                            </div>
                            <div class="col-lg-2">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">History Details</p>
                                <a href="history.php?id=<?php echo$row['account'];?>"><i class="btn btn-primary">Show all History</i></a>
                                <?php 
                                $_SESSION["hi"]=true;
                                 ?>
                            </div>
