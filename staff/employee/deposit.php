...
if (isset($_POST['transfer'])){
  ...
  if($rs1){
    ...
    if ($connected){
      $msg="Hello dear ".$name."! You have deposit balance in your SKY BANK account  on ".$tms1.". Amount ".$newbnc.".00$ deposit successfully. Your current account balance is ".$bnc1.".00$. Thank you for joining SKY BANK service.";
                  ...
                  if(mysqli_num_rows($nm)>0){
                    ...
                    <div class="row">
                        ...
                        <div  class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="blnc" value="<?php echo $row['balance'].".00 $";?>"  readonly>
                        </div>
                    </div>
                    <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
                   ...
                   <div class="row">
                        <div  class="col-sm-5">
                            <p for="exampleInputEmail1" style="margin-bottom: 1px; margin-top: 8px;">Deposit Amount</p>
                            <input type="number" class="form-control" name="amount" id="am" min="500" placeholder="Enter deposit amount" required>
                        </div>
                        <div  class="col-sm-2">
                        <input type="submit"  class="btn btn-primary form-control" style="margin-top: 28px; font-size: 17px; width: 120px; border-radius: 5px;" name="transfer" id="trans" value="Deposit" onclick="var vl = document.getElementById('am').value; var e=this;var s=document.getElementById('sbtn');setTimeout(function(){if(vl>=500){e.disabled=true;s.disabled=true;}},0); return true;">
                       </div>
                    </div>
                    </form>
                    <?php
