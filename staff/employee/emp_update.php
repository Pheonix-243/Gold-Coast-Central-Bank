...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);
 if (isset($_POST['insert'])){
        ...
        $sql1="UPDATE users as u,emp_details as a set a.id='$emp_id',a.name='$name',a.fname='$fname',a.cnic='$cnic',a.contect='$contect',a.dob='$dob',a.gender='$gender',a.email='$email',a.postal='$postal',a.city='$city',a.houseaddress='$address',a.edu='$edu',a.exp='$exp',u.role='$type',u.username='$username',a.title='$title' where u.id=a.id and a.id='$id'";
        ...
        if($rs){
          ...
          $imgData = addslashes(file_get_contents($_FILES['userImage']['tmp_name']));
           mysqli_query($con,"UPDATE emp_details set image='$imgData' where id='$id'");
          }
          $_SESSION["title"]="Done";
                   ...
                   <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" name="edu" placeholder="Enter your education" value="<?php echo $row['edu'];?>" required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Current Job Title</p>
                                <input type="text" class="form-control" id="title" name="title" placeholder="Enter current job title"  value="<?php echo $row['title'];?>" required>
                            </div>
                           <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Experience</p>
                                <select class="form-control" name="experience" required>
                                  <?php if($row['exp']=="Fresh") {?>
                                ...
                                <?php }?>
                                <?php if($row['exp']=="Less then 1 Year") {?>
                                  <option value="Fresh">Fresh</option>
                                  <option value="Less then 1 Year" selected>Less then 1 Year</option>
                                  <option value="1 Year">1 Year</option>
                                  <option value="2 Year">2 Year</option>
                                  <option value="3 Year">3 Year</option>
                                  <option value="4 Year">4 Year</option>
                                ...
                                <?php if($row['exp']=="2 Year") {?>
                                  ...
                                  <option value="Above then 5 Year">Above then 5 Year</option>
                                <?php }?>
                                <?php if($row['exp']=="3 Year") {?>
                                  <option value="Fresh">Fresh</option>
                                  <option value="Less then 1 Year">Less then 1 Year</option>
                                  <option value="1 Year">1 Year</option>
                                  <option value="2 Year">2 Year</option>
                                  <option value="3 Year" selected>3 Year</option>
                                  <option value="4 Year">4 Year</option>
                                  <option value="5 Year">5 Year</option>
                                  <option value="Above then 5 Year">Above then 5 Year</option>
                                <?php }?>
                                <?php if($row['exp']=="4 Year") {?>
                                  <option value="Fresh">Fresh</option>
                                  <option value="Less then 1 Year">Less then 1 Year</option>
                                  <option value="1 Year">1 Year</option>
                                  <option value="2 Year">2 Year</option>
                                  <option value="3 Year">3 Year</option>
                                  <option value="4 Year" selected>4 Year</option>
                                  <option value="5 Year">5 Year</option>
                                  <option value="Above then 5 Year">Above then 5 Year</option>
                                <?php }?>
                                <?php if($row['exp']=="5 Year") {?>
                                  <option value="Fresh">Fresh</option>
                                  <option value="Less then 1 Year">Less then 1 Year</option>
                                  <option value="1 Year">1 Year</option>
                                  <option value="2 Year">2 Year</option>
                                  <option value="3 Year">3 Year</option>
                                  <option value="4 Year">4 Year</option>
                                  <option value="5 Year" selected>5 Year</option>
                                  <option value="Above then 5 Year">Above then 5 Year</option>
                                <?php }?>
                                <?php if($row['exp']=="Above then 5 Year") {?>
                                  <option value="Fresh">Fresh</option>
                                  <option value="Less then 1 Year">Less then 1 Year</option>
                                  <option value="1 Year">1 Year</option>
                                  <option value="2 Year">2 Year</option>
                                  ...
                                  <option value="4 Year">4 Year</option>
                                  <option value="5 Year">5 Year</option>
                                  <option value="Above then 5 Year" selected>Above then 5 Year</option>
                                <?php }?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="email" class="form-control" name="username" placeholder="Enter username for login" value="<?php echo $row['username'];?>" required>
                            </div>
                           <div class="col-lg-4">
                                ...
                                <select class="form-control" name="user_type" required>
                                  ...
                                  <?php 
                                    ...
                                    <option value="Admin" selected>Assistant Admin</option>
                                  <?php
                                   }
                                   }else{
                                   ?>
