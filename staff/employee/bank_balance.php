    ...
    <section class="content" id="top">
       <div class="container-fluid">
            <div class="block-header">
                <div  class="col-sm-8">
                <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">Bank Balance History</p>
            </div>
            <div class="col-sm-4">
              <?php 
                  ...
                  <table class="table" id="myTable">
                    <thead>
                      <tr style="text-align: center;" class="tb">
                          ...
                          <th style="text-align: center; width: 17%;">Sender / Reciever Account</th>
                    ...
                    <tbody id="body">
                      ...
                      ?>
                       <tr>
                          ...
                          <?php
                          }else if($row['type']=="Deposit" || $row['type']=="Withdraw" ){
                            ?>
